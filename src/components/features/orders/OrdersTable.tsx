...
const _columns: GridColDef<Order>[] = [
  ...
  { field: 'manager', headerName: 'Lider', flex: 1 },
  { field: 'inventoryType', headerName: 'Producto', flex: 1 },
  ...
  // TODO: totalPayments out of termMonths??
  ...
  { field: 'totalPayments', headerName: 'Pagos', flex: 1 },
  {
    field: 'onTimePayment',
...
// const _columns2: GridColDef<Order>[] = [
//   {
//     field: 'number',
//     headerName: 'Folio',
//     minWidth: 100,
