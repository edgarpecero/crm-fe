const localizedTextsMap = {
  ...
  toolbarFiltersTooltipActive: (count: number) => `${count} filtro${count !== 1 ? "s" : ""} activo${count !== 1 ? "s" : ""}`,
  ...
  columnHeaderFiltersTooltipActive: (count: number) => `${count} filtro${count !== 1 ? "s" : ""} activo${count !== 1 ? "s" : ""}`,
  columnHeaderFiltersLabel: "Filtros",
  columnHeaderSortIconLabel: "Ordenar",
  footerRowSelected: (count: number) => `${count} fila${count !== 1 ? "s" : ""} seleccionada${count !== 1 ? "s" : ""}`,
  footerTotalRows: "Total de filas:",
  footerTotalVisibleRows: (visibleCount: number, totalCount: number) => `${visibleCount} de ${totalCount}`,
